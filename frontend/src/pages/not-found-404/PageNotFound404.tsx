    ...
    return (
        <div className="not-found-body">
            <div className="not-found-container">
                ...
                <h1 className="not-found-h1">404 - Seite nicht gefunden</h1>
                <p className="not-found-p">Leider konnten wir die gewünschte Seite nicht finden.</p>
                <p className="not-found-p">Klicken Sie <a className="not-found-a" href="/"> hier um zur Startseite zurückzukehren</a>.</p>
            </div>
        </div>
    );
}
